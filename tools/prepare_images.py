...
ITEMS: tuple[ImageItem, ...] = (
    ...
    ImageItem("commercial-lakeside-luggage", p("DSCF9183 2.JPG"), "Lakeside commercial fashion portrait with statement luggage", "commercial"),
    ImageItem("commercial-lakeside-bench", p("DSCF8982.JPG"), "Lakeside commercial beauty portrait in a patterned dress", "commercial"),
    ImageItem("commercial-summer-duo", p("DSCF8841.jpg"), "Commercial summer fashion portrait of two models", "commercial"),
